...
async function updateaddmoney_transaction(userid,txnid,amount,productinfo,email,mobileno,name,uniqueid){
    ...
    try{
         console.log('Credit Card Online Payment Update Transaction Line 1');
      ...
      console.log(name);
	   console.log(uniqueid);
		console.log('Credit Card Online Payment Update Transaction Line 2');
            const conn= await sql.connect(config);
            const res =await conn.request()
		...
		console.log('Credit Card Online Payment Update Transaction Line 6');
            return data;
...
//INSURENCE PART END
 ...
 router.get("/verifypayudeposit/:id", async  function(req, res){
	  console.log('---verify payment fetch--line--01---');
  try {


    console.log('---verify payment fetch--line--1---');
     console.log(req.params.id)
    const data = await payuClient.verifyPayment(req.params.id);
    const status = data.transaction_details[req.params.id];
	   console.log(status);
     ...
     console.log(status.transaction_amount);
	   ...
	   console.log(status.error_Message);
     console.log('---verify payment fetch--line--2---');
    if (status.status === "success") 
      {

  console.log('---verify payment fetch--line--3---');
                          ...
                          const data = result["recordset"];
                           console.log(' Response:', data);
                            ...
                            console.log(result["recordset"][0].paytype);
										...
										console.log('---verify payment fetch--line--4---');
                          res.json({
                                      status:"success",
                                      paytype:'deposit',    
                                      redirect:'success',
         ...
         console.log('---verify payment fetch--line--5---');
...
async function addmoney_transaction(userid,txnid,amount,productinfo,email,mobileno,name){
    ...
    try{
        ...
        console.log('---ADD Money INICIATE  --1---');
      console.log(userid);
      console.log(txnid);
      console.log(amount);
      console.log(productinfo);
      ...
      console.log(mobileno);
      console.log(name);
   console.log('---ADD Money INICIATE  --2---');
            const conn= await sql.connect(config);
            const res =await conn.request()
            ...
            const data = res.recordset;
            //  console.log('sp Response:', data);
			   console.log('---ADD Money INICIATE  --3---');
            return data;
...
//CREDIT CARD START 
router.post("/billfetch_creditcard", async  function(request, response){


    try
    {               

    console.log('req bill fetch credit');
    ...
    console.log(request.body.paraname1);
    console.log(request.body.paraname2);
    console.log('req bill fetch credit-1');
    const databillfetch = await funcbillfetch_creditcard(request.body.billerid,request.body.uniqueid,request.body.paraname,request.body.accountno,request.body.mobileno,request.body.token,request.body.paraname1,request.body.paraname2);

          console.log('--CREDIT CARD-----minmum value');     
      console.log(databillfetch.status_id);
      console.log(databillfetch.billNumber);
      console.log(databillfetch.amount);
      console.log(databillfetch.name);
      ...
      console.log(databillfetch.additionalInfo[0].infoValue);    

      console.log('Unbilled Amount');
      console.log(databillfetch.additionalInfo[1].infoValue); 
      console.log('Current Outstanding Amount');
     // console.log(databillfetch.additionalInfo[2].infoValue); 
 //console.log(databillfetch.message);
  console.log('xxi');
      if(databillfetch.message =="Success")
      {
         console.log('a1');  
		if(databillfetch.additionalInfo[2] != null)
		{
		
		  console.log('a2');  
		const datainsertbillfetch = await  insert_transaction_billfetch_creditcard(request.body.userid,request.body.accountno,request.body.billerid,request.body.uniqueid,request.body.serviceprovidername,request.body.mobileno,databillfetch.amount,request.body.paidtype,request.body.category,request.body.paraname,request.body.token,databillfetch.billNumber,databillfetch.name,databillfetch.dueDate,databillfetch.billdate,databillfetch.reference_id,request.body.ip,databillfetch.message,databillfetch.additionalInfo,databillfetch.additionalInfo[0].infoValue,databillfetch.additionalInfo[2].infoValue,databillfetch.additionalInfo[1].infoValue);
        ...
        console.log(datainsertbillfetch.Message); 
         ...
         response.json({
                         ...
                         accountno:datainsertbillfetch.accountno,
                          ...
                          customername:datainsertbillfetch.customername,
                          BillDate:datainsertbillfetch.billdate, 
                          CurrentOutstandingAmount:databillfetch.additionalInfo[2].infoValue, 
						  MinimumAmountDue:databillfetch.additionalInfo[0].infoValue,
			  ...
			  console.log('a3');  
			const datainsertbillfetch = await  insert_transaction_billfetch_creditcard(request.body.userid,request.body.accountno,request.body.billerid,request.body.uniqueid,request.body.serviceprovidername,request.body.mobileno,databillfetch.amount,request.body.paidtype,request.body.category,request.body.paraname,request.body.token,databillfetch.billNumber,databillfetch.name,databillfetch.dueDate,databillfetch.billdate,databillfetch.reference_id,request.body.ip,databillfetch.message,databillfetch.additionalInfo,databillfetch.additionalInfo[0].infoValue,databillfetch.additionalInfo[1].infoValue);
        ...
        console.log(datainsertbillfetch.Message); 
         ...
         response.json({
                  ...
                  const datainsertbillfetch = await  insert_transaction_billfetch_creditcard(request.body.userid,request.body.accountno,request.body.provideid,request.body.uniqueid,request.body.serviceprovidername,request.body.mobileno,databillfetch.amount,request.body.paidtype,request.body.category,request.body.name,request.body.token,databillfetch.billNumber,databillfetch.name,databillfetch.dueDate,databillfetch.billdate,databillfetch.reference_id,request.body.ip,databillfetch.message,databillfetch.additionalInfo[0].infoValue,databillfetch.additionalInfo[2].infoValue,databillfetch.additionalInfo[1].infoValue);
                    console.log('xxxxxxxxxxxxxxxxx');  
...
async function funcbillfetch_creditcard(billerid,uniqueid,name,accountno,mobileno,token, paraname1, paraname2) {
  
var requestBody = JSON.stringify({"billerId":billerid,"client_id":uniqueid,"customerParams":[{"name":name,"value":accountno},{"name":paraname1,"value":mobileno}]});
...
async function insert_transaction_billfetch_creditcard(userid,accountno,provideid,myuniqueid,serviceprovidername,mobileno,amount,paidtype,category,paraname,token,billNumber,customername,dueDate,billdate,reference_id,ip, message,additionalInfo, minimumdueamount,currentoutstandingamount,unbilledamt){
    ...
    try{
            ...
            .input("Minimumamount",minimumdueamount)
            .input("CurrentOutStandingAmount",currentoutstandingamount)
            .input("Unbilled_Amt",unbilledamt)
            .execute("usp_insertTransaction_Creditcard_billfetch");
            const data = res.recordset[0];
             console.log('sp Responsett:', data);
            return data;
...
router.post("/billfetch_Insurance", async  function(request, response){
   ...
   console.log('----------------------------');
	...
	const myArray = request.body.dob.split("-");
    ...
    const databillfetch = await funcbillfetch_Insurance(request.body.billerid,request.body.uniqueid,request.body.paraname,finaldob,request.body.paraname1,request.body.emailID,request.body.paraname2,request.body.accountno,request.body.token);
...
async function funcbillfetchpay_test(accountno,referenceid,amount,billerid,uniqueid,name,mobileno,token) {
  
    console.log('function credit card test--1'); 
   console.log(accountno); 
      console.log(billerid); 
         console.log(amount); 
   console.log(uniqueid); 
            console.log(mobileno); 
            console.log(token); 
    console.log('function credit card test--2');  


const form = new FormData();
form.append('number', '9861238493');
form.append('provider_id', '1');
form.append('amount', '9');
form.append('client_id', uniqueid);
form.append('optional1', '9861238493');
form.append('api_id', '27');
form.append('optional2', '');
form.append('optional3', '');
form.append('optional4', '');
